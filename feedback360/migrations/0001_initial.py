...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scale_choices', models.JSONField(blank=True, default=list, help_text="В формате [['значение', 'описание'], ...]", null=True)),
                ('text', models.TextField()),
                ('answer_type', models.CharField(choices=[('scale', 'Шкала'), ('text', 'Текст'), ('multiple', 'Множественный выбор')], max_length=50)),
                ...
                ('sort_order', models.IntegerField(blank=True, default=0, null=True)),
                ('competency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='feedback360.competency')),
            ],
            options={
                'verbose_name': 'Вопрос',
        ...
        migrations.AddField(
            model_name='survey',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='feedback360.surveytemplate', verbose_name='Шаблон'),
        ),
        migrations.AddField(
            model_name='competency',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competencies', to='feedback360.surveytemplate'),
        ),
        migrations.CreateModel(
            name='Response',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer_value', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, validators=[django.core.validators.MinValueValidator(0.5), django.core.validators.MaxValueValidator(10)])),
